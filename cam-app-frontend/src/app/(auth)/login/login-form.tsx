        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center">
            <input
              ...
              className="h-4 w-4 rounded border-gray-700 bg-[#18181b] text-purple-600 focus:ring-purple-500"
            />
      ...
      {!mfa && (
        <>
          ...
          <div className="flex space-x-4">
            <button
              type="button"
              className="flex-1 flex items-center justify-center py-2 px-4 border border-gray-700 rounded-md shadow-sm bg-[#18181b] hover:bg-gray-800 transition-colors"
            ...
            >
              <svg className="w-5 h-5 text-[#5865F2]" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
